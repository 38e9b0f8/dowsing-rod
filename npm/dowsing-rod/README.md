...
Requires Node 18+. Prebuilt binaries target macOS 10.12+ on Intel, macOS 11+ on Apple Silicon, Windows x64, and glibc 2.17+ on Linux x64/arm64. This covers RHEL 8–10, supported Ubuntu, Debian, Fedora, and SUSE releases. Node can impose a higher OS floor. musl/Alpine and Windows arm64 are not currently provided.
